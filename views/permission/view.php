	...
	<div class="col-sm-6">
		<div class="panel panel-default">
			...
			<div class="panel-body">
                ...
                <input type="text" name="child_routes[]" class="form-control input-sm">
				<div class="row">
					<div class="col-sm-3">
						<?= Html::submitButton(
							'<span class="glyphicon glyphicon-ok"></span> ' . UserManagementModule::t('back', 'Save'),
                    ...
                    <table class="table">
                    <?php foreach(ArrayHelper::map($childRoutes, 'name', 'name') as $key):?>
                        <tr>
                            <td><input type="checkbox" name="child_routes_remove[]" value="<?=$key?>"></td>
                            <td><?=$key?></td>
                        </tr>
                    <?php endforeach?>
                    </table>
